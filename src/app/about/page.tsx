...
export default function AboutPage() {
  return (
        ...
        <div className="max-w-2xl mx-auto px-5 py-10 text-sm leading-relaxed text-gray-800">
      <h1 className="text-2xl font-bold text-center mb-6">🙋 About Me</h1>
      <p className="mb-5">
        Hi, I’m <span className="font-semibold">Anand Jaiswal</span>, a curious learner in the field of <span className="font-semibold">Computer Science</span>.<br />
        I’ve explored many fundamental areas of CS but haven’t fully settled on a single path yet.
      </p>

      <h2 className="text-lg font-semibold mt-8 mb-3 border-l-4 border-indigo-500 pl-2">
      ...
      <h2 className="text-lg font-semibold mt-8 mb-3 border-l-4 border-indigo-500 pl-2">✨ Why This Blog?</h2>
      <ul className="space-y-1 list-disc list-inside text-gray-700">
      ...
      <h2 className="text-lg font-semibold mt-8 mb-3 border-l-4 border-indigo-500 pl-2">🌱 Beyond Tech</h2>
      <ul className="space-y-1 list-disc list-inside text-gray-700">
